...
当你向大模型询问一个概念时，回答里经常会引出新的术语。传统聊天里，如果继续追问新术语，原来的主线容易被打断。本项目把回答组织成横向卡片：主概念保留在原位，回答中的关键词可以继续生成下一张卡片，从而形成一条可回溯的理解路径。
